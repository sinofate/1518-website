const services = [
  ["每日宜忌", "结合黄历宜忌、干支冲煞、吉神凶煞和个人八字喜用生成每日行动参考。", "daily"],
  ["黄道吉日", "为结婚、开业、签约、搬家等大事筛选候选吉日，并结合个人八字与吉时排序。", "auspicious"],
...
const defaultSeo = {
  ...
  description: "1518 起名网是长期运营20年的中文起名测名工具站，由《易经》专家孔力担任产品顾问，提供姓名测试、公司名测试、每日宜忌、黄道吉日、个人起名、公司起名、品牌起名、周公解梦、生肖星座、号码测算等传统文化参考服务。",
  keywords: "1518起名网,起名网,姓名测试,姓名打分,名字测试,每日宜忌,黄道吉日,结婚吉日,开业吉日,签约吉日,今日黄历,黄历宜忌,八字择日,个人起名,宝宝起名,公司起名,公司名测试,品牌起名,品牌名测试,周公解梦,生肖查询,生肖配对,星座查询,星座配对,生日密码,风水查询,血型分析,手机号测算,车牌测算",
  headline: "1518 起名网"
};
const routeSeo = {
  home: defaultSeo,
  ...
  daily: {
    title: "每日宜忌_黄历宜忌_八字择日参考 - 1518 起名网",
    description: "1518 每日宜忌按查询日期读取黄历宜忌、农历干支、冲煞、吉神凶煞、财神喜神方位和时辰吉凶，并结合个人八字喜用生成每日行动建议。",
    keywords: "每日宜忌,今日黄历,黄历宜忌,老黄历,八字择日,吉时查询,财神方位,冲煞查询,1518每日宜忌",
    headline: "每日宜忌"
  },
  auspicious: {
    title: "黄道吉日_结婚开业签约择日_八字择日 - 1518 起名网",
    description: "1518 黄道吉日面向结婚嫁娶、开业开市、签约交易、搬家入宅等重要事项，结合黄历宜忌、冲煞、吉神凶煞、个人八字喜用和吉时筛选候选日期。",
    keywords: "黄道吉日,结婚吉日,开业吉日,签约吉日,搬家吉日,八字择日,老黄历择日,吉日查询,1518黄道吉日",
    headline: "黄道吉日"
  },
  "company-test": {
  ...
  "all-tools": {
    ...
    description: "1518 全栏目工具集合姓名测试、每日宜忌、黄道吉日、个人起名、公司名测试、公司起名、品牌起名、周公解梦、生肖星座、风水、血型、手机号和车牌测算。",
