...
const defaultSeo = {
  ...
  description: "1518 起名网是长期运营20年的中文起名测名工具站，由《易经》专家孔力担任产品顾问，提供姓名测试、公司名测试、每日宜忌、个人起名、公司起名、品牌起名、周公解梦、生肖星座、号码测算等传统文化参考服务。",
  keywords: "1518起名网,起名网,姓名测试,姓名打分,名字测试,每日宜忌,今日黄历,黄历宜忌,八字择日,个人起名,宝宝起名,公司起名,公司名测试,品牌起名,品牌名测试,周公解梦,生肖查询,生肖配对,星座查询,星座配对,生日密码,风水查询,血型分析,手机号测算,车牌测算",
  headline: "1518 起名网"
};
const routeSeo = {
  home: defaultSeo,
  ...
  "all-tools": {
    ...
    description: "1518 全栏目工具集合姓名测试、每日宜忌、个人起名、公司名测试、公司起名、品牌起名、周公解梦、生肖星座、风水、血型、手机号和车牌测算。",
