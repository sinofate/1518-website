...
const routeSeo = {
  ...
  "company-test": {
    ...
    description: "1518 公司名测试按公司全称、商号简称、行业属性和 81 数理生成企业名称诊断，分析品牌传播力、行业适配、融资扩张和经营稳定度。",
  ...
  phone: {
    ...
    description: "1518 手机号测算按号码尾数、数字五行、81 数理和重复结构生成号码报告，提供手机号码吉凶和数字能量参考。",
    keywords: "手机号测算,手机号码吉凶,号码测试,手机号码测试,数字能量,手机号打分,1518手机号测算",
    headline: "手机号测算"
  },
  plate: {
    title: "车牌测算_车牌号码吉凶_车牌号测试 - 1518 起名网",
    description: "1518 车牌测算按车牌数字、字母、尾号和 81 数理生成车牌参考报告，适合车牌号吉凶和车牌号码测试。",
    keywords: "车牌测算,车牌号码吉凶,车牌号测试,车牌号码测试,车牌打分,车牌吉凶,1518车牌测算",
    headline: "车牌测算"
  },
  orders: {
    title: "订单查询_起名报告查询_1518订单状态 - 1518 起名网",
    description: "1518 订单查询用于查询姓名报告、个人起名、公司起名和企业命名订单状态，支持订单号或手机号查询入口。",
    keywords: "订单查询,1518订单查询,起名报告查询,姓名报告,公司起名订单,报告下载",
    headline: "订单查询"
  },
  "all-tools": {
